...
"use strict";
/* harmony import */ var _kissmybutton_motorcortex__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(444);
...
/* harmony import */ var _kissmybutton_motorcortex_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(573);
...
var MyPlugin = (0,_kissmybutton_motorcortex__WEBPACK_IMPORTED_MODULE_0__.loadPlugin)((_dist_motorcortex_comets_umd__WEBPACK_IMPORTED_MODULE_2___default()));
...
new (_kissmybutton_motorcortex_player__WEBPACK_IMPORTED_MODULE_1___default())({
  clip: clip
});
...
!function (t, n) {
  ...
  function Q(t) {
    var n = function (t) {
      return T(t ? L(I.arr(t) ? t.map(B) : B(t)) : [], function (t, n, e) {
  ...
  function tt(t, n) {
    ...
    return t.tweens.map(function (o) {
      ...
      return I.und(a) && (a = l), r.from = K(u, f), r.to = K($(a, u), f), r.start = e ? e.end : 0, r.end = r.start + r.duration, r.isPath = !1, r.isColor = I.col(r.from.original), r.isColor && (r.round = 1), e = r, r;
    });
  }
  ...
  at.version = "3.1.0", at.get = H, at.set = et, at.convertPx = U, at.penner = R, at.path = function (t) {
    return {
      el: t,
      svg: ut(t),
      totalLength: lt(t),
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("95a0ce005b87bf3a734f")
/******/ 	})();
/******/ 	
